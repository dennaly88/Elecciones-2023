                  ...
                  <div class="row">
                    <div class="col-lg-4 col-xs-6">
                      <div class="small-box bg-primary">
                        ...
                        <a href="#" class="small-box-footer">Nomina Completra de VTV  <i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-xs-6">
                      <div class="small-box bg-green">
                        ...
                        <a href="#" class="small-box-footer">Empleados que Si Votaron <i class="fa fa-arrow-circle-right"></i></a>
    ...
    -------------------->
                    ...
                    <div class="col-lg-4 col-xs-6">
                      <div class="small-box bg-red">
                        ...
                        <a href="#" class="small-box-footer">Empleados que NO Votaron  <i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
